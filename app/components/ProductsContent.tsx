...
export const rubberProducts = [
  { slug: 'single-component-bonding-agent', name: 'Resorcinol free Single Component Bonding Agent', image: 'https://res.cloudinary.com/dgif730br/image/upload/v1763392803/unsplash_x8ZStukS2PM_1_flkza9.svg', category: 'rubber' },
  { slug: 'resorcinol-masterbatch', name: 'Resorcinol Masterbatch', image: 'https://res.cloudinary.com/dgif730br/image/upload/v1770016055/R_80_S.0103c49e_qal2bm.jpg', category: 'rubber' },
  { slug: 'rfl-dipping', name: 'RFL Dipping', image: 'https://res.cloudinary.com/dgif730br/image/upload/v1770016424/WhatsApp_Image_2026-01-28_at_5.56.45_PM_w3smtj_xjk4bf.jpg', category: 'rubber' },
...
export const plasticProducts = [
  ...
  { slug: 'dispersing-additive-anti-fibrillation', name: 'Dispersing Additive for Anti-fibrillation', image: 'https://res.cloudinary.com/dgif730br/image/upload/v1770018273/Rafia_Tape.jpg_fr55z5.jpg', category: 'plastic' },
